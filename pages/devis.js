...
export default function DevisPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Simulation d'envoi API (à remplacer par ta vraie API)
            await new Promise((resolve) => setTimeout(resolve, 2500));

            // Ici ton fetch POST réel
            ...
            <div className="container mx-auto px-6 py-12 sm:py-16 bg-gray-50 font-sans">
                ...
                >
                    ...
                    <p className="text-base sm:text-lg max-w-3xl mx-auto opacity-90 px-4">
                        Obtenez une estimation précise et personnalisée pour vos envois de la Belgique à Goma.
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        ...
                        <div>
                            <label htmlFor="nom" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Nom Complet
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="email" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Adresse Email
                            </label>
                            <input
                                type="email"
                        ...
                        <div className="md:col-span-2">
                            <label htmlFor="telephone" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Numéro de Téléphone
                            </label>
                            <input
                                type="tel"
                        ...
                        <div>
                            <label htmlFor="typeEnvoi" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Type d'Envoi Souhaité
                            </label>
                            <select
                                id="typeEnvoi"
                                name="typeEnvoi"
                                value={formData.typeEnvoi}
                                onChange={handleChange}
                                className="w-full px-4 py-2.5 sm:px-5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-gray-700 appearance-none bg-white pr-8"
                                required
                            >
                        ...
                        <div>
                            <label htmlFor="poidsEstime" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Poids Estimé (kg)
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label htmlFor="volumeEstime" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Volume Estimé (m³ ou cm³)
                            </label>
                            <input
                                type="text"
                                id="volumeEstime"
                        ...
                        <div className="md:col-span-2">
                            <label
                                ...
                                className="block text-gray-800 text-base sm:text-lg font-medium mb-2"
                            >
                            ...
                            <textarea
                                ...
                                placeholder="Ex: Vêtements, documents, effets personnels, pièces auto..."
                                required
                            ></textarea>
                        </div>
                        ...
                        <div>
                            <label htmlFor="adresseDepart" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Adresse de Départ (Belgique)
                            </label>
                            <input
                                type="text"
                                id="adresseDepart"
                                ...
                                onChange={handleChange}
                                className="w-full px-4 py-2.5 sm:px-5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-gray-700 placeholder-gray-400"
                                placeholder="Adresse complète en Belgique (ex: Bruxelles)"
                                required
                            />
                        </div>

                        <div>
                            <label htmlFor="adresseArrivee" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                                Adresse d'Arrivée (Goma, RDC)
                            </label>
                            <input
                                type="text"
                                id="adresseArrivee"
                                ...
                                onChange={handleChange}
                                className="w-full px-4 py-2.5 sm:px-5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-gray-700 placeholder-gray-400"
                                placeholder="Adresse complète à Goma"
                                required
                            />
                        </div>

                        <div className="md:col-span-2">
                            <label htmlFor="dateSouhaitee" className="block text-gray-800 text-base sm:text-lg font-medium mb-2">
                        ...
                        <div className="md:col-span-2">
                            <label
                                ...
                                className="block text-gray-800 text-base sm:text-lg font-medium mb-2"
                            >
                                Besoin ou Détail Spécifique (optionnel)
                            </label>
                            <textarea
                                ...
                                rows="4"
                                className="w-full px-4 py-2.5 sm:px-5 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-200 text-gray-700 resize-y placeholder-gray-400"
                                placeholder="Ex: Marchandises fragiles, besoin d'assurance spéciale, dates de livraison impératives..."
                            ></textarea>
                        </div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base">
                                        Merci pour votre demande. Nous l'examinons attentivement et vous contacterons très bientôt avec une estimation personnalisée.
                                    </p>
                                </div>
                            </motion.div>
                        )}
                        ...
                        {submissionStatus === 'error' && (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base">
                                        Désolé, une erreur est survenue lors de l'envoi de votre demande. Veuillez réessayer plus tard ou nous contacter directement.
                                    </p>
                                </div>
                            </motion.div>
                        )}
